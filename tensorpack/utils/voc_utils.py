...
# File: voc_utils.py
# Author: philipcheng
# Time: 6/14/16 -> 10:02 AM
"""
The following code is based on https://github.com/mprat/pascal-voc-python
"""
import pandas as pd
import os
...
class VocUtil(object):
    ...
    def _load_data(self, category, data_type=None):
        ...
        to_find = category
        filename = os.path.join(self.root_dir, 'csvs/') + \
            data_type + '_' + \
            category + '.csv'
